...
//        this.addressTextField.setText(getAccountForPassphrase(SRC_ACCOUNT).getAddress().encodeAsString());
...
//                agreementTextArea.setText(te.getAgreement().getContents());
...
//    private String sourceAccount = "only atom opera jealous obscure fade drama bicycle near cable company other hazard math argue anxiety corn approve crumble trust hunt cattle parent ability raw";
